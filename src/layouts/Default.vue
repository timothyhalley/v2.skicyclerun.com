      ...
      >
        <div>
          ...
          <g-link v-else to="/" @click.native="scrollToTop">
            <g-image
              src="~/assets/images/ux_FaceMasks.svg"
              class="w-10 h-10"
              alt="logo"
            />
          </g-link>
        ...
        >
          ...
          <li>
            <a
              v-if="$route.path === '/'"
              href="/#photos"
              v-scroll-to="{ el: '#photos', offset: -25 }"
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            ...
            >
              ...
              >
                <path
                  d="M 34 2.5 v 29 A 2.5 2.5 0 0 1 31.5 34 H 2.5 A 2.5 2.5 0 0 1 0 31.5 V 2.5 A 2.5 2.5 0 0 1 2.5 0 h 29 A 2.5 2.5 0 0 1 34 2.5 Z M 10 13 H 5 V 29 h 5 Z m 0.45 -5.5 A 2.88 2.88 0 0 0 7.59 4.6 H 7.5 a 2.9 2.9 0 0 0 0 5.8 h 0 a 2.88 2.88 0 0 0 2.95 -2.81 Z M 29 19.28 c 0 -4.81 -3.06 -6.68 -6.1 -6.68 a 5.7 5.7 0 0 0 -5.06 2.58 H 17.7 V 13 H 13 V 29 h 5 V 20.49 a 3.32 3.32 0 0 1 3 -3.58 h 0.19 c 1.59 0 2.77 1 2.77 3.52 V 29 h 5 Z"
                  fill-rule="nonzero"
                />
              </svg>
            </a>
